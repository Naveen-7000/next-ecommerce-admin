            ...
            properties.map((property, idx) => (
              <div key={idx} className="flex gap-1 mt-1">
                <input
                  ...
                  value={property.name}
                  onChange={(e) =>
                    handlePropertyNameChange(idx, property, e.target.value)
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    handlePropertyValueChange(idx, property, e.target.value)
                  }
                ...
                <tr key={category._id}>
                  ...
                  <td className="flex gap-1">
                    <button
                      ...
                      className="btn-default flex justify-center items-center gap-1"
                    >
                      <svg
                    ...
                    <button
                      ...
                      className="btn-red flex justify-center items-center gap-1"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
